...
# Future Work
We plan to investigate and analyse some un-reasonable results we got and improve our simple model. And we also plan to consider more climate factors such as precipitation, wind speed. In addition, we also plan to study other species using our method. We can also modified our network to study animals' behavior such as migration.
