...
# Future Work
In the future, we plan to consider more climate factors such as precipitation, wind speed. In addition, we also plan to study other species using our method. We can also modified our network to study animals' behavior such as migration.
